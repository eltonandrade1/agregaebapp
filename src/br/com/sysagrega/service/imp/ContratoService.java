...
public class ContratoService implements IContratoService {
	...
	private void validaCamposObrigatorios(IContrato contrato) {
		...
		} else if (contrato.getNomeCliente().isEmpty() || contrato.getNomeCliente() == null) {
			
			throw new NegocioException("Favor informar o nome do cliente!");
	...
	public List<Contrato> getContratoByFilter(String nrContrato, String filtroCliente) {
		...
		return this.contratoRepository.getContratoByFilter(nrContrato, filtroCliente);
