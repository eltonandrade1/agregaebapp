...
public class ItensControleContrato implements IItensControleContrato {
	...
	/* (non-Javadoc)
	 * @see br.com.sysagrega.model.imp.IItensControleContrato#getId()
	 */
	@Override
	public Long getId() {
		return id;
	...
	/* (non-Javadoc)
	 * @see br.com.sysagrega.model.imp.IItensControleContrato#setId(java.lang.Long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see br.com.sysagrega.model.imp.IItensControleContrato#getNrEstudo()
	 */
	@Override
